...
#   timestamp: 2025-10-07T17:24:07+00:00
...
class Runtime(BaseModel):
    ...
    def get_active_model(self, model_name: Optional[str] = None) -> Model:
        """Get the active model config (specified, default, or first).

        Args:
            model_name: Optional specific model to get

        Returns:
            Model configuration

        Raises:
            ValueError: If no models configured or model_name not found
        """
        if not self.models:
