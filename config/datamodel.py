...
#   timestamp: 2025-10-02T03:24:09+00:00
...
class Runtime(BaseModel):
    default_model: Optional[str] = Field(
        None,
        description="Name of the default model to use (references models.{name}). If not specified and models is defined, uses first model.",
    )
    models: Optional[dict[str, Any]] = Field(
        None,
        description="Named model configurations for multi-model support. Each key is a model name, value is the configuration.",
    )
    provider: Optional[Provider] = Field(
        None,
        description="LEGACY: Runtime provider. Use models.{name}.provider instead for multi-model setups.",
    )
    model: Optional[str] = Field(
        None,
        description="LEGACY: Model name or ID. Use models.{name}.model instead for multi-model setups.",
    )
    base_url: Optional[str] = Field(
        None, description="LEGACY: Base URL for the provider. Use models.{name}.base_url instead."
    )
    api_key: Optional[str] = Field(
        None, description="LEGACY: API key for the provider. Use models.{name}.api_key instead."
    )
    huggingface_token: Optional[str] = Field(
        None,
        description="LEGACY: Hugging Face API token. Use models.{name}.huggingface_token instead.",
    )
    instructor_mode: Optional[str] = Field(
        None, description="LEGACY: Instructor mode. Use models.{name}.instructor_mode instead."
    )
    prompt_format: Optional[PromptFormat] = Field(
        None, description="LEGACY: Prompt format. Use models.{name}.prompt_format instead."
    )
    model_api_parameters: Optional[dict[str, Any]] = Field(
        None,
        description="LEGACY: Additional API parameters. Use models.{name}.model_api_parameters instead.",
    )
    lemonade: Optional[Lemonade] = Field(
        None, description="LEGACY: Lemonade configuration. Use models.{name}.lemonade instead."
    )
