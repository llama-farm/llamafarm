...
#   timestamp: 2025-09-23T19:06:51+00:00
...
class DatasetWithFileDetails(BaseModel):
    ...
    database: str = Field(..., description="RAG database to use for the dataset")
    files: list[str] = Field(..., description="List of file hashes")
    file_details: list[FileDetail] = Field(..., description="Detailed file information")
...
class Runtime(BaseModel):
    ...
    instructor_mode: Optional[InstructorMode] = Field(
        "md_json",
        description="Instructor mode to use for structured output (tools, json, or md_json)",
    )
...
class LlamaFarmConfig(BaseModel):
    ...
    dataset_file: Optional[DatasetFile] = Field(
        None, description="Represents a file in a dataset with metadata"
    )
    dataset_with_file_details: Optional[DatasetWithFileDetails] = Field(
        None, description="Dataset with detailed file information"
    )
    runtime: Runtime
