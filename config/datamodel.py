...
#   timestamp: 2025-10-31T13:18:11+00:00
...
class RAGStrategyConfigurationSchema(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    ...
    databases: Optional[list[DatabaseDefinition]] = Field(
        None,
        description="Independent database definitions with their own embedding/retrieval strategies",
        min_length=1,
        title="Database Configurations",
    )
    data_processing_strategies: Optional[list[DataProcessingStrategyDefinition]] = Field(
        None,
...
class LlamaFarmConfig(BaseModel):
    ...
    prompts: Optional[list[PromptSet]] = Field([], description="List of named prompt sets")
    rag: Optional[RAGStrategyConfigurationSchema] = Field(
        None,
