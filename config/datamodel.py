...
#   timestamp: 2025-09-08T20:46:58+00:00
...
class DataProcessingStrategy(BaseModel):
    ...
    allowed_mime_types: Optional[list[str]] = Field(
        None,
        description="MIME types this strategy accepts (empty means accept all)",
        examples=[["application/pdf"], ["text/csv", "application/vnd.ms-excel"], []],
    )
    allowed_extensions: Optional[list[constr(pattern=r"^\.[a-zA-Z0-9]+$")]] = Field(
        None,
        description="File extensions this strategy accepts (empty means accept all)",
        examples=[[".pdf"], [".csv", ".xlsx", ".xls"], []],
    )
