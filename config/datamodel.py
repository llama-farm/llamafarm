...
try:
    from server.core.encrypted_field import EncryptedString, encrypted_field
    ENCRYPTION_AVAILABLE = True
except ImportError:
    ENCRYPTION_AVAILABLE = False
    EncryptedString = str
    def encrypted_field(**kwargs):
        return Field(**kwargs)
...
class Runtime(BaseModel):
    ...
    api_key: Optional[EncryptedString] = encrypted_field(
        None,
        description="API key for the provider (automatically encrypted at rest)"
    )
