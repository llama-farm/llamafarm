...
async def cli_upgrade():
    try:
        ...
        raise HTTPException(status_code=503, detail="Unable to reach GitHub releases") from exc

    published_at = None
    if release.published_at:
        published_at = release.published_at.astimezone(timezone.utc).isoformat()
