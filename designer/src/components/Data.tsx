  ...
  return (
    ...
    >
      ...
      <div className="w-full flex flex-col h-full">
        ...
        {isDragging ? (
          <div
            className={`w-full h-full flex flex-col items-center justify-center border-[1px] border-dashed rounded-lg p-4 gap-2 transition-colors border-[#85B1FF]`}
          >
          ...
          <div>
            ...
            {isLoading && droppedFiles.length <= 0 ? (
              <div className="w-full flex flex-col items-center justify-center border-[1px] border-solid rounded-lg p-4 gap-2 transition-colors border-[#85B1FF]">
              ...
              droppedFiles.length <= 0 && (
                <div className="w-full flex flex-col items-center justify-center border-[1px] border-dashed rounded-lg p-4 gap-2 transition-colors border-[#85B1FF]">
                  <div className="flex flex-col items-center justify-center gap-4 text-center my-[56px]">
                    <FontIcon type="upload" className="w-10 h-10 text-white" />
                    <div className="text-xl">Drop data here to start</div>
                    <button
                      className="text-sm py-2 px-6 border-[1px] border-solid border-white rounded-lg hover:bg-white hover:text-[#017BF7]"
                      onClick={() => {
            ...
            {droppedFiles.length > 0 &&
              droppedFiles.map((file, i) => (
                <div className="w-full bg-[#131E45] rounded-lg py-2 px-4 text-white text-sm mt-2 flex justify-between items-center">
                  <div
                  ...
                  <div className="w-1/2 flex justify-between items-center">
                    <div className="flex items-center gap-2">
                      <div className="text-[#85B1FF] text-xs">MX-log-data</div>
                      <FontIcon
                        type="chevron-down"
                        className="w-4 h-4 text-[#85B1FF]"
                      />
                    </div>
                    <div className="flex items-center gap-6">
                      <div className="flex items-center gap-2">
                        <FontIcon
                          ...
                          className="w-4 h-4 text-[#85B1FF]"
                        />
                        <div className="text-xs text-[#85B1FF]">Processing</div>
                      </div>
                      <FontIcon
                        type="trashcan"
                        className="w-4 h-4 text-[#85B1FF]"
