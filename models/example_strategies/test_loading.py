...
def main():
    ...
    # Test cases
    test_cases = [
        ("basic_openai.yaml", "basic_openai"),
        ("ollama_local_models.yaml", "ollama_local_models"),
        ("production_cloud.yaml", "production_cloud"),
        ("multi_model_specialized.yaml", "multi_model_specialized"),
        ("local_inference_engines.yaml", "huggingface_transformers"),
        ("local_inference_engines.yaml", "vllm_high_throughput"),
        ("fine_tuning_workflows.yaml", "pytorch_lora_finetuning"),
        ("fine_tuning_workflows.yaml", "llamafactory_comprehensive"),
    ]
