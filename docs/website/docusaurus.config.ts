...
const config: Config = {
  ...
  scripts: [
    {
      src: 'https://www.googletagmanager.com/gtm.js?id=GTM-KQZL3NKC',
      async: true,
    },
  ],
...
})(window,document,'script','dataLayer','GTM-KQZL3NKC');`,
    },
    {
      tagName: 'noscript',
      attributes: {},
      innerHTML: `<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KQZL3NKC"
