...
EXAMPLE_CONFIG="${SCRIPT_DIR}/llamafarm-example-large-complex.yaml"
...
info "Next: run './examples/large-complex-rag/run_example.sh' (optionally pass the project root)."
