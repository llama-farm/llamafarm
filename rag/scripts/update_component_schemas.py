...
def update_markdown_parser():
    ...
    defaults = {
        "general_purpose": {
            ...
            "recommended_for": ["Documentation", "README files", "Blog posts"],
        },
        "technical_docs": {
...
def update_docx_parser():
    ...
    defaults = {
        "general_purpose": {
            ...
            "recommended_for": ["Reports", "Letters", "General documents"],
        },
        "with_comments": {
...
def update_excel_parser():
    ...
    defaults = {
        "general_purpose": {
            ...
            "recommended_for": ["Spreadsheets", "Data tables", "Reports"],
        },
        "financial_data": {
            "name": "Financial Data",
...
def update_html_parser():
    ...
    defaults = {
        "general_purpose": {
            ...
            "recommended_for": ["Web pages", "HTML documents", "Email templates"],
        },
        "text_extraction": {
...
def update_text_parser():
    ...
    # Schema
    schema = create_json_schema_header(
        "parsers", "text_parser", "Text Parser Configuration", "Parses plain text files"
    )
    schema["properties"] = {
        "encoding": {
            "type": "string",
    ...
    defaults = {
        "general_purpose": {
            ...
            "recommended_for": ["Text files", "Log files", "Plain documents"],
        },
        "large_documents": {
            ...
            "recommended_for": ["Books", "Large reports", "Long articles"],
        },
    }
