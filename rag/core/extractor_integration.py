...
class ExtractorIntegrator:
    ...
    def __init__(self, extractor_config: list[dict[str, Any]] | None = None):
        """
    ...
    def _setup_pipeline(self) -> None:
        ...
        try:
            ...
            logger.info(
                f"Created extractor pipeline with {len(self.pipeline.extractors)} extractors"
            )
    ...
    def process_documents(
        self, documents: list[Document], file_path: Path | None = None
    ) -> list[Document]:
        """
        ...
        try:
            ...
            logger.debug(
                f"Enhanced {len(enhanced_documents)} documents with extractors"
            )
...
def create_extractor_integrator(config: dict[str, Any]) -> ExtractorIntegrator | None:
    """
...
def enhance_processing_result(
    ...
    integrator: ExtractorIntegrator | None,
...
def apply_extractors_from_cli_args(
    ...
    extractor_configs: dict[str, dict[str, Any]] | None = None,
) -> list[Document]:
    """
