...
class LlamaIndexParser(BaseParser):
    ...
    def _create_text_splitter(self):
        ...
        if chunk_strategy == "sentences":
            ...
            try:
                ...
                logger.warning("Semantic chunking unavailable, falling back to sentence splitting")
    ...
    def _llama_to_rag_documents(self, llama_docs: List) -> List[Document]:
        ...
        for llama_doc in llama_docs:
            ...
            metadata['parser_version'] = self.metadata.version if hasattr(self, 'metadata') else '1.0.0'
        ...
        for doc in documents:
            ...
            for i, chunk in enumerate(chunks):
                ...
                chunk_metadata.update({
                    ...
                    'has_overlap': self.config.get('chunk_overlap', 0) > 0 and i > 0
                })
