...
REGISTRY_DATA = {
    "file_extensions": {
        ...
        ".docx": [
            {"parser": "DoclingParser", "priority": 0, "tool": "Docling"},
            {"parser": "MarkItDownParser", "priority": 1, "tool": "MarkItDown"},
            {"parser": "DocxParser_PythonDocx", "priority": 2, "tool": "python-docx"},
            {"parser": "DocxParser_LlamaIndex", "priority": 3, "tool": "LlamaIndex"},
        ],
        ".go": [
            {"parser": "TextParser_LlamaIndex", "priority": 0, "tool": "LlamaIndex"}
        ],
        ...
        ".pdf": [
            {"parser": "DoclingParser", "priority": 0, "tool": "Docling"},
            {"parser": "MarkItDownParser", "priority": 1, "tool": "MarkItDown"},
            {"parser": "PDFParser_PyPDF2", "priority": 2, "tool": "PyPDF2"},
            {"parser": "PDFParser_LlamaIndex", "priority": 3, "tool": "LlamaIndex"},
        ],
        ".php": [
            {"parser": "TextParser_LlamaIndex", "priority": 0, "tool": "LlamaIndex"}
        ],
        ...
        ".xlsx": [
            {"parser": "DoclingParser", "priority": 0, "tool": "Docling"},
            {"parser": "MarkItDownParser", "priority": 1, "tool": "MarkItDown"},
            {"parser": "ExcelParser_OpenPyXL", "priority": 2, "tool": "OpenPyXL"},
            {"parser": "ExcelParser_Pandas", "priority": 3, "tool": "Pandas"},
            {
                "parser": "ExcelParser_LlamaIndex",
                "priority": 4,
                "tool": "LlamaIndex-Pandas",
    ...
    "parsers": {
        ...
        "DoclingParser": {
            ...
            "dependencies": {
                "required": ["docling", "docling-core"],
                "optional": ["transformers", "torch"],
            },
            "description": "Advanced document parser using IBM's Docling library with "
            "AI-powered layout analysis and smart chunking",
            "display_name": "Docling Parser (IBM)",
            "implementation_dir": "components/parsers/docling",
            "mime_types": [
                "application/pdf",
                "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
        ...
        "MarkItDownParser": {
            ...
            "dependencies": {
                "required": ["markitdown"],
                "optional": ["openai", "azure-ai-documentintelligence"],
            },
            "description": "Fast document-to-markdown converter using Microsoft's MarkItDown",
            "display_name": "MarkItDown Parser (Microsoft)",
            "implementation_dir": "components/parsers/markitdown",
            "mime_types": [
                "application/pdf",
                "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
                "application/vnd.openxmlformats-officedocument.presentationml.presentation",
            ...
            "parser_type": "multi",
            "supported_extensions": [".pdf", ".docx", ".pptx", ".xlsx", ".xls", ".html",
