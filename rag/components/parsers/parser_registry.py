...
REGISTRY_DATA = { 'file_extensions': { '.asc': [ {'parser': 'TextParser_Python', 'priority': 0, 'tool': 'Python'},
                       ...
                       '.mkd': [ {'parser': 'MarkdownParser_Python', 'priority': 0, 'tool': 'Python'},
                                 {'parser': 'MarkdownParser_LlamaIndex', 'priority': 0, 'tool': 'LlamaIndex'}],
                       '.msg': [{'parser': 'MsgParser_ExtractMsg', 'priority': 0, 'tool': 'extract-msg'}],
  ...
  'mime_types': { 'application/csv': [ {'parser': 'CSVParser_Pandas', 'tool': 'Pandas'},
                  ...
                  'application/octet-stream': [{'parser': 'MsgParser_ExtractMsg', 'tool': 'extract-msg'}],
                  ...
                  'application/vnd.ms-outlook': [{'parser': 'MsgParser_ExtractMsg', 'tool': 'extract-msg'}],
  ...
  'parsers': { 'CSVParser_LlamaIndex': { 'capabilities': [ 'text_extraction',
               ...
               'MarkdownParser_Python': { 'capabilities': [ 'text_extraction',
                                          ...
                                          'tool': 'Python',
                                          'version': '1.0.0'},
               'MsgParser_ExtractMsg': { 'capabilities': [ 'text_extraction',
                                                           'metadata_extraction',
                                         ...
                                         'default_config': { 'chunk_overlap': 100,
                                                             ...
                                                             'preserve_formatting': False},
                                         'dependencies': { 'optional': ['chardet', 'python-magic'],
  ...
  'tools': { 'LlamaIndex': [ { 'capabilities': [ 'text_extraction',
             ...
             'Python csv': [ { 'capabilities': ['text_extraction', 'chunking', 'basic_metadata'],
                               ...
                               'type': 'csv'}],
             'extract-msg': [ { 'capabilities': [ 'text_extraction',
                                                  'metadata_extraction',
                                                  'attachment_extraction',
                                                  'chunking',
                                                  'email_parsing',
