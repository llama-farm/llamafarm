...
class MarkdownParser_Python:
    ...
    def __init__(self, name: str = "MarkdownParser_Python", config: Optional[Dict[str, Any]] = None):
        self.name = name
        ...
        try:
            ...
            if self.extract_metadata:
                ...
                if self.extract_code_blocks:
                    ...
                    metadata["code_languages"] = list(set(cb.get("language", "plain") for cb in code_blocks))
    ...
    def _split_by_sections(self, content: str) -> List[Dict[str, Any]]:
        ...
        if self.chunk_size:
            ...
            for section in sections:
                ...
                elif len(current_merged["content"]) + len(section["content"]) <= self.chunk_size:
