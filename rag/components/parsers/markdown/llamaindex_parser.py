...
class MarkdownParser_LlamaIndex:
    ...
    def __init__(self, name: str = "MarkdownParser_LlamaIndex", config: Optional[Dict[str, Any]] = None):
        self.name = name
    ...
    def parse(self, source: str, **kwargs):
        ...
        try:
            ...
            return ProcessingResult(
                documents=[],
                errors=[{"error": "LlamaIndex not installed. Install with: pip install llama-index", "source": source}]
            )
