...
class DocxParser_LlamaIndex:
    ...
    def __init__(self, name: str = "DocxParser_LlamaIndex", config: Optional[Dict[str, Any]] = None):
        self.name = name
    ...
    def parse(self, source: str, **kwargs):
        ...
        try:
            ...
            return ProcessingResult(
                documents=[],
                errors=[{"error": "LlamaIndex not installed. Install with: pip install llama-index llama-index-readers-file", "source": source}]
            )
            ...
            for llama_doc in llama_docs:
                ...
                if self.extract_metadata:
                    try:
                        ...
                        logger.debug("python-docx not available for enhanced metadata extraction")
