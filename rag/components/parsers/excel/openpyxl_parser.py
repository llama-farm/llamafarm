...
class ExcelParser_OpenPyXL:
    ...
    def __init__(self, name: str = "ExcelParser_OpenPyXL", config: Optional[Dict[str, Any]] = None):
        self.name = name
        ...
        self.data_only = self.config.get("data_only", True)  # True = values, False = formulas
    ...
    def parse(self, source: str, **kwargs):
        ...
        try:
            ...
            return ProcessingResult(
                documents=[],
                errors=[{"error": "OpenPyXL not installed. Install with: pip install openpyxl", "source": source}]
            )
        ...
        try:
            ...
            for sheet_name in sheet_names:
                ...
                if self.chunk_size and self.chunk_size > 0 and len(rows) > self.chunk_size:
