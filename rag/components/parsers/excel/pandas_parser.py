...
class ExcelParser_Pandas:
    ...
    def __init__(self, name: str = "ExcelParser_Pandas", config: Optional[Dict[str, Any]] = None):
        self.name = name
    ...
    def parse(self, source: str, **kwargs):
        ...
        try:
            ...
            return ProcessingResult(
                documents=[],
                errors=[{"error": "Pandas not installed. Install with: pip install pandas openpyxl", "source": source}]
            )
        ...
        try:
            ...
            for sheet_name in sheet_names:
                ...
                if self.chunk_size and self.chunk_size > 0 and len(df) > self.chunk_size:
