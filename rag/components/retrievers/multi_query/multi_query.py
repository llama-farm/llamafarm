...
class MultiQueryStrategy(RetrievalStrategy):
    ...
    def __init__(
        ...
        self.search_multiplier = config.get(
            "search_multiplier", 2
        )  # How many extra results to get per query
        ...
        **kwargs,
        ...
        for i, query_var in enumerate(query_variations):
            documents = vector_store.search(
                ...
                top_k=top_k
                * self.search_multiplier,  # Get more results for aggregation
            )
            total_searches += 1
        ...
        for doc_id, score in sorted_docs:
            ...
            doc.metadata["query_frequency"] = len(
                doc_scores[doc_id]
            )  # How many queries found this doc
