...
def hash_document(file_path: str, content: str | None = None) -> str:
    """
...
def generate_chunk_metadata(
    ...
    chunk_id = generate_chunk_id(
        parent_doc_metadata["document_hash"], chunk_index, chunk_hash
    )
